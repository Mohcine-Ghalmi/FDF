...
/*   Updated: 2023/02/25 17:56:35 by mghalmi          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_mlx_give(t_fdf *fdf_data)
{
	...
	fdf_data->mlx_win = mlx_new_window(fdf_data->mlx_ptr, 2000, 1500, "FDF");
	fdf_data->mlx_image = mlx_new_image(fdf_data->mlx_ptr, 2000, 1500);
